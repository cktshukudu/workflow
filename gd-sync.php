    ...
    if(!empty($file_id)){
        ...
        if(!empty($fileData)){
            ...
            if(!empty($_SESSION['google_access_token'])){
                ...
                $data = $gd_api->GetAccessToken(GOOGLE_CLIENT_ID, REDIRECT_URI, GOOGLE_CLIENT_SECRET, $_GET['code']);
            ...
            if(!empty($access_token)){
                ...
                try {
                    ...
                    $drive_file_id = $gd_api->UploadFileToDrive($access_token, $file_content, $mime_type);
                    ...
                    if($drive_file_id){
                        ...
                        $drive_file_meta = $gd_api->UpdateFileMeta($access_token, $drive_file_id, $file_meta);
